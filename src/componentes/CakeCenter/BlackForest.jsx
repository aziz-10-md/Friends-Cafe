...
import fruit1 from "../../assets/black.png.png"
import Menus3 from '../menus/Menus3';
export default function BlackForest() {
  return (
    <div className="container grid grid-cols-1 md:grid-cols-2 min-h[650px] relative">
        {/* Brand info */}
        <div className=' w-72 flex justify-center items-center md:right-14 ' >
          <motion.img
            ...
            viewport={{once:true}}
            src={fruit1}
            alt="" className='w-[200px]  md:w-[450px] drop-shadow' />
        </div>
        <div className='flex flex-col justify-center py-14 md:py-0 relative z-10 '>
          <div className=' text-center md:text-left spacy-y-6 lg:max-w-[400px]'>
            <motion.h1
              ...
              Black <span className='text-secondary'>Forest</span>
            </motion.h1>
            <motion.p
              variants={FadeRight(0.9)}
              initial='hidden'
              animate='visible'
              className='text-2xl tracking-wide'>Order Now For Happy Life</motion.p>
            < motion.p
